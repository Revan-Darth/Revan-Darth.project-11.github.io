...
// Динамический адаптив ===============================================
	...
	daAdapt.init();
// Лайк-Дизлайк кнопки ================================================
	const svgOpacityGreen = document.querySelector('.svg-opacity--green');
	if(svgOpacityGreen) {
		svgOpacityGreen.addEventListener('click', function (e) {
			svgOpacityGreen.classList.toggle('_active');
		});
	}
	const svgOpacityRed = document.querySelector('.svg-opacity--red');
	if(svgOpacityRed) {
		svgOpacityRed.addEventListener('click', function (e) {
			svgOpacityRed.classList.toggle('_active');
		});
	}
